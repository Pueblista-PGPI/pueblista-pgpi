...
class CustomUserManager(BaseUserManager):
    ...
    def create_user(self, dni, nombre, apellidos, telefono, direccion_postal,
        ...
        # Genera contraseña aleatoria cifrada, pero que no se usará realmente
        if password is None:
    ...
    def create_superuser(self, dni, nombre, apellidos, telefono,
                         direccion_postal, fecha_nacimiento,
...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    # Define si el usuario tiene acceso a partes administrativas (no /admin)
    is_staff = models.BooleanField(default=False)
    # Define si el usuario es superusuario y tiene acceso completo a /admin
