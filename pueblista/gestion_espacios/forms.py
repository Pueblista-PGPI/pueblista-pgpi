...
class EspacioPublicoForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['nombre', 'horario', 'descripcion', 'fotos', 'telefono', 'estado', 'subespacios', 'espacio_especial', 'limpieza']
        widgets = {
            ...
            'subespacios': forms.TextInput(attrs={'class': 'form-control form-control-lg'}),
