...
def home(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            messages.error(request, 'Ha ocurrido un error al enviar el mensaje.')
        
    return render(request, 'home.html', {"ayuntamiento": texto_ayuntamiento, "pueblista": texto_pueblista, "contact_text": 'Contacta con nosotros!'})