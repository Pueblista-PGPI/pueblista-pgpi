...
| - | - | - |
|*Director de Proyecto*|- Crear el Acta de Constitución, el Plan de Dirección del Proyecto, y los planes de cronograma y presupuesto.- Supervisar la ejecución del proyecto, asegurando que se cumplan los objetivos de tiempo, costo y calidad.- Facilitar reuniones periódicas con stakeholders y comunicar los avances clave.- Monitorear y ajustar los planes del proyecto según sea necesario.- Gestionar los recursos del proyecto, tanto humanos como financieros.|- Liderazgo y toma de decisiones.- Habilidad de planificación y organización.- Comunicación efectiva y resolución de conflictos.- Conocimiento de herramientas de gestión de proyectos (MS Project, herramientas ágiles, etc).|
|*Analista-técnico*|- Recopilar y analizar los requisitos del sistema, asegurando que sean claros y alcanzables.- Documentar los requisitos y especificaciones del sistema, junto con el alcance de este.- Elaborar la documentación de la fase de planificación.- Colaborar con el <a name="_int_ultvliff"></a>Director de Proyecto para asegurar que los entregables cumplan con las expectativas.- Apoyar en la identificación de riesgos y supuestos asociados a los requisitos.|- Análisis de sistemas y documentación de requisitos.- Comunicación y negociación con stakeholders.- Pensamiento crítico y atención al detalle.- Conocimiento en metodologías de análisis y modelado de sistemas.- Conocimiento en negocios y dominios de tecnología.- Habilidad de absorber y entender rápidamente cualquier información.|
|*Responsable gestión de la comunicación e información*|- Crear el Plan de Gestión de las Comunicaciones y asegurarse de que todos los miembros del proyecto están bien informados.- Establecer y mantener canales de comunicación efectivos entre todos los stakeholders.- Monitorear y documentar el flujo de información, asegurando su correcta distribución.|- Comunicación y habilidades interpersonales.- Organización y habilidad para gestionar la información de manera estructurada.- Conocimiento en herramientas de comunicación (Slack, Teams, etc.).- Habilidad para crear reportes de estado de manera clara y precisa.|
|*Responsable de aseguramiento de la calidad*|- Desarrollar y mantener el Plan de Gestión de Calidad, asegurando que se cumplan los estándares de calidad definidos.- Realizar auditorías de calidad periódicas para evaluar el cumplimiento de los requisitos de calidad.- Monitorear y validar los entregables para asegurar que cumplan con los estándares de calidad.- Colaborar con el equipo de desarrollo para implementar mejoras en los procesos.|- Conocimiento en estándares de calidad y accesibilidad (ISO, CMMI, WCAG 2.1).- Habilidad para realizar auditorías y evaluaciones de calidad.- Orientación a los detalles y habilidades de documentación.- Capacidad de análisis y mejora de procesos.|
|*Responsable de Gestión de riesgos*|- Identificar, evaluar y documentar los riesgos del proyecto en el Registro de Riesgos.- Monitorear los riesgos y ejecutar los planes de respuesta para mitigar impactos negativos.- Realizar revisiones periódicas del estado de los riesgos y actualizar las estrategias de mitigación.- Comunicar los riesgos y sus posibles impactos al Director de Proyecto y otros stakeholders relevantes.|- Habilidad para identificar y evaluar riesgos.- Capacidad de planificación y desarrollo de estrategias de mitigación.- Conocimiento en metodologías de gestión de riesgos (PMI, ISO 31000).- Comunicación efectiva para informar sobre riesgos y su evolución.|
